...
public class InvMovementService extends ServiceImpl<InvStockMovementMapper, InvStockMovement> {
    ...
    public PageResult<InvStockMovement> pageMovements(Integer page, Integer size, Long warehouseId,
        ...
        wrapper.eq(warehouseId != null, InvStockMovement::getWarehouseId, warehouseId)
                ...
                .eq(StrUtil.isNotBlank(sourceNo), InvStockMovement::getSourceNo, sourceNo)
