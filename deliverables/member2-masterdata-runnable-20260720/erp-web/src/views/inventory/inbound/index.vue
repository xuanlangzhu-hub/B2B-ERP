...
import { getInbounds, confirmInbound, createInboundFromPurchase, cancelInbound } from '@/api/inventory'
...
const query = reactive({
  page: 1, size: 10,
  inboundNo: '', warehouseId: '', status: '', dateRange: [] as string[]
})
...
function handleViewDetail(row: any) {
  detailItems.value = row.items || row.details || []
